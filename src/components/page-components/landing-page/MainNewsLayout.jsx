    ...
    <>
      <div className="col-span-12 grid grid-cols-12 gap-6 self-start xl:col-span-8">
        ...
        <div className="col-span-12 grid grid-cols-12 gap-4">
          {/* info */}
          <div key={crypto.randomUUID()} className="col-span-12 lg:col-span-4">
          ...
          {/* thumb */}
          <div key={crypto.randomUUID()} className="col-span-12 lg:col-span-8">
        ...
        >
          ...
          {/* thumb */}
          <div key={crypto.randomUUID()} className="col-span-12 md:col-span-6">
