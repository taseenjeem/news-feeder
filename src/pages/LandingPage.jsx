            ...
            <div className="col-span-12 grid grid-cols-12 gap-6 self-start xl:col-span-8">
              ...
              <div className="col-span-12 grid grid-cols-12 gap-4">
                ...
                <div className="col-span-12 lg:col-span-8">
                  <img className="w-full" src={thumb1} alt="thumb" />
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-4">
                ...
                <div className="col-span-12 md:col-span-4">
                  ...
                  <p className="text-base text-[#292219]">
                    Rising longer-term rates should boost profitability after
                    many difficult years for sector
                  </p>
                  <p className="mt-5 text-base text-[#94908C]">25 Feb 2021</p>
                </div>
              </div>
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-4">
                ...
                <div className="col-span-12 md:col-span-4">
                  ...
                  <p className="text-base text-[#292219]">
                    If fixed-income no longer offers stability, look elsewhere
                    for protection from equity volatility
                  </p>
                  <p className="mt-5 text-base text-[#94908C]">25 Feb 2021</p>
                </div>
              </div>
